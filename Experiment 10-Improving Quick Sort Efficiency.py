...
# Increase recursion limit for deterministic quicksort on sorted arrays
...
def run_benchmark_for_size(N):
    """Runs the benchmark suite for a specific input size N"""
    print(f"\n==================== EXPERIMENT FOR N = {N} ====================")
...
# ==============================================================================
# MULTIPLE INPUT SIZE EXPERIMENTAL SEGMENT
# ==============================================================================
# Define the different values of N you want to demonstrate as examples
sample_sizes = [1000, 2500, 5000]

for n_size in sample_sizes:
    run_benchmark_for_size(n_size)
